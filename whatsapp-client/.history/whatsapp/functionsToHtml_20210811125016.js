...
function removeMessage(id , currentUser){
    routerFunctions("DELETE",`${urlMessages}?messageId=${id}&senderId=${currentUser}`,getAllMessagesOfSender);
}

function removeMessageGroup(id , currentUser , nameGroup){
    routerFunctions("DELETE",`${urlMessages}?messageId=${id}&senderId=${currentUser}&nameGroup=${nameGroup}`,getAllMessagesOfGroups);
}
